...
//         © {new Date().getFullYear()} PerfumeShop • Built by Manhar
//       </div>
//     </footer>
//   );
// }
...
// function Footer() {
//   return (
//     <footer className="bg-black text-gray-300 px-8 py-10 mt-12">
//       <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        
//         {/* Brand */}
//         <div>
//           <h3 className="text-white text-xl font-semibold mb-3">PERFUMÉ</h3>
//           <p className="text-sm">
//             Premium fragrances crafted to match your personality and style.
//           </p>
//         </div>
...
//             <li className="hover:text-white cursor-pointer">Exclusive</li>
//           </ul>
//         </div>
...
//           <p className="text-sm">Email: v-perfumes@perfume.com</p>
