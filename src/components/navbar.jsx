...
//         <li onClick={() => navigate("/order")} className="hover:text-gray-300 cursor-pointer">Order</li>
//         </ul>
...
function Navbar() {
  ...
  return (
    <nav className="w-full bg-black text-white px-6 py-4 sticky top-0 z-50">
      <div className="flex items-center justify-between">
        <h1
          className="text-2xl font-bold cursor-pointer"
          onClick={() => navigate("/")}
      ...
      {menuOpen && (
        <div className="md:hidden mt-4 border-t border-gray-700">
          <ul className="flex flex-col gap-4 p-4 text-sm">
            ...
            <li onClick={() => handleProtectedNav("/wishlist", "Login to view wishlist")}>
              Wishlist ({wishlistCount})
            </li>
            {user ? (
              <li onClick={logout} className="text-red-500">Logout</li>
            ) : (
